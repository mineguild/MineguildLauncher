...
public class LogEntry {
    ...
    public LogEntry message(String message) {
        ...
        if (level == LogLevel.UNKNOWN) {
            ...
            if (message.contains("[severe]") || message.contains("[stderr]") || message
                .contains("[error]")) {
    ...
    private static String getLocation(StackTraceElement[] stackTraceElements) {
        for (StackTraceElement ste : stackTraceElements) {
            if (!ste.getClassName().equals(Logger.class.getName()) && !ste.getClassName()
                .equals(LogEntry.class.getName())) {
