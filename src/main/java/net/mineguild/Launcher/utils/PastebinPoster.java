...
public class PastebinPoster extends SwingWorker<Boolean, Void> {
    ...
    @Override protected Boolean doInBackground() throws Exception {
        try {
            String body = "api_option=paste&api_dev_key=" + URLEncoder
                .encode(Constants.PASTEBIN_API_KEY, "utf-8") + "&api_paste_code=" + URLEncoder
                .encode(postContent, "utf-8") + "&api_paste_private=1"
                + "&api_paste_name=MineguildLauncher-Log";
