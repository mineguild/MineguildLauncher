...
public class CryptoUtils {
     ...
     */
    @Deprecated public static String decryptLegacy(String str, byte[] key) {
     ...
     * @return decrypted string or "" if fails
     */
    @Deprecated public static String encryptLegacy(String str, byte[] key) {
        BigInteger str2;
        try {
    ...
    /**
     * Method to AES decrypt string if fails, will attempt to use
     * {@link #decryptLegacy(String str, byte[] key)}
     *
     * @param str string to decrypt
    ...
    /**
     * Method to AES encrypt string if fails, will attempt to use
     * {@link #encryptLegacy(String str, byte[] key)}
     *
