...
@SuppressWarnings("serial") public class LoginDialog extends JDialog {
    ...
    public LoginDialog(Frame parent) {
        ...
        dataPanel.setLayout(new FormLayout(
        ...
        userField.getDocument().addDocumentListener(new DocumentListener() {
            ...
            private void resetStuff() {
                if (settings.getProfile() != null) {
                    if (!settings.getProfile().get("username").equals(userField.getText())) {
    ...
    public void loggedIn(LoginWorker w, boolean mojangData, boolean hasPassword, String user,
        ...
        try {
            ...
            if (e instanceof UserMigratedException) {
                ...
                JOptionPane
                    .showMessageDialog(this, "Other error occurred: " + e.getLocalizedMessage());
