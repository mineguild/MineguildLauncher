...
@SuppressWarnings("serial") public class MultithreadedDownloadDialog extends JDialog
    ...
    @Override public void propertyChange(PropertyChangeEvent evt) {
        if (evt.getPropertyName().equals("overall")) {
            ...
            @SuppressWarnings("unchecked") HashMap<String, Object> info =
                (HashMap<String, Object>) evt.getNewValue();
            status.setText(String.format("Downloading file %d of %d", info.get("currentFile"),
                info.get("overallFiles")));
