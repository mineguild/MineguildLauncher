...
public class LaunchFrame extends JFrame {
  ...
  public LaunchFrame() {
    ...
    dlThreadsSpinner.setModel(new SpinnerNumberModel(new Integer(1), new Integer(1), null,
        new Integer(1)));
  ...
  public void doVersionCheck() {
    ...
    try {
      ...
      if (!localPackFile.exists()) {
        ...
        needsUpdate = true;
        result =
            JOptionPane.showConfirmDialog(this, String.format("A new update (%s %s) is available! Update now?",
